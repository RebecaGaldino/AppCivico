...
public class ListarSinesBRActivity extends AppCompatActivity {
    @BindView(R.id.lvSinesBR) ListView lvSines;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_sines_br);
    ...
    public void listarSinesBR(){

        new Thread(new Runnable() {
            @Override
            public void run() {

                Call<List<Sine>> call = ServerConnection.getInstance().getService().getSinesBR();
